      ...
      <section id="content">
      	 <div class="container">
         	...
         	<div class="col-sm-4">
               <div class="card">
                  <div class="card-header bgm-bluegray m-b-20">
                     <h2>Reset Course <small>Phasellus condimentum ipsum id auctor</small></h2>               
                        <button class="btn bgm-blue btn-float waves-effect"><i class="zmdi zmdi-arrow-right"></i></button>
                  </div>
            ...
            <div class="col-sm-4">
               <div class="card">
                  <div class="card-header bgm-bluegray m-b-20">
                     <h2>Reset Assignment <small>Phasellus condimentum ipsum id auctor</small></h2>               
                        <button class="btn bgm-blue btn-float waves-effect"><i class="zmdi zmdi-arrow-right"></i></button>
                  </div>
                  <div class="card-body card-padding">
                      Cras leo sem, egestas a accumsan eget, euismod at nunc. Praesent vel mi blandit, tempus ex gravida, accumsan dui. Sed sed aliquam augue. Nullam vel suscipit purus, eu facilisis ante. Mauris nec commodo felis. 
